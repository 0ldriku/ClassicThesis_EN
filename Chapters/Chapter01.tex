...
\subsection{Japanese References}
...
The \texttt{yomi} field should contain the romanized reading of Japanese names in hiragana. When provided, references will be sorted according to the Japanese 50-on table order. This ensures proper bibliographic ordering for Japanese-language sources.

\textbf{Note:} Chinese references can also use \texttt{langid=japanese}, though they will be rendered in Japanese fonts in the bibliography. This is generally acceptable for mixed CJK bibliographies. 
