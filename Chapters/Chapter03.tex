...
\begin{description}
    ...
    \item[Version History] Change the version history details in \texttt{VersionHistory.tex}.
\end{description}
...
\paragraph{About This Template:} This template is based on the \texttt{classicthesis} package (version 4.8) by André Miede and Ivo Pletikosić. It has been modified and extended with:
\begin{itemize}
